...
#managedIdentity
$UAMI = 'mi-p-sourcecontrol' #Modify: MI name
$UAMIobj = 'eac2080f-e15e-49c6-bcbc-8ef9cc5853f9' #Modify: MI objectID
$UAMIclientId = '62d2534c-d420-4d0e-8ca9-a74590cb3d46' #Modify: MI clientID
$UAMIRG = "rg-p-test_aa_ghmanaged" #Modify: MI Resource Group name
#endregion
